...
if(strlen($_SESSION['alogin'])==0)
    ...
    header('location:../../Login.php');
		...
		move_uploaded_file($_FILES["img"]["tmp_name"],"../../Image/Gallery/" .$image);		


		$sql = "INSERT INTO gallery(Image,Details) 
				VALUES(:image,:details)";
		...
		if($query)
		{
		header('Location: ../Gallery.php?image_added');
		}
		else 
		{
		header('Location: Add-image.php?image_notadded');
			...
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0" class="nav nav-pills">
			  ...
			  <li class="nav-item dropdown active">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				  ...
				  <a class="dropdown-item active" href="Add-image.php">Add Image</a>	
				  <div class="dropdown-divider"></div>
				</div>
			  </li>
...
<div class="container" id="2">
	  <div class="title">
		   <font size="6" color="#ff1a1a">Add Image</font>
	  </div> 
	 <form action="Add-image.php" method="POST" enctype="multipart/form-data">
	  <div class="form-row">	  	  
			<div class="form-group col-md-6">
			  <label for="">Details</label>
			  <input type="text" class="form-control" id="" name="details" required>
			</div>				
	  </div>	   
	  <br>
	  <div class="form-row">
