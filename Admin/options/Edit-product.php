...
if(strlen($_SESSION['alogin'])==0)
	{	
		...
		$sql = "UPDATE product SET  ProductName='$productname',Discription='$discription',Price='$price' WHERE id='$id' ";
		...
		header('Location: ../Shop.php?Update-successfully');
	 ...
	 <form action="" method="POST" >
         ...
         <fieldset disabled>
			...
			<div class="form-group col-md-12">
			  ...
			  <input type="text" class="form-control" value="<?php echo htmlentities($result->Price);?>" name="price" >
			</div>			
