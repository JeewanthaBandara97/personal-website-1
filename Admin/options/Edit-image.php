...
if(strlen($_SESSION['alogin'])==0)
    ...
    header('location:../../Login.php');
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"../../Image/Gallery/" .time() . '-'.$_FILES["img1"]["name"]);
		...
		header('Location: ../Gallery.php?Image-updated-successfully ');
...
<!-- ################################################################################-->	
			...
			<div class="col mb-4 form-group">
				<div class="card h-100">
				  <img src="../../Image/Gallery/<?php echo htmlentities($result->Image);?>" class="card-img-top" width="310" height="195" style="z-index:1">
				  <div class="card-body">
