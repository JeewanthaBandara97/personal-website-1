...
<div class="container">
    ...
    <div class="row row-cols-1 row-cols-md-3">
					...
					$query = $dbh->prepare("SELECT * FROM gallery WHERE id LIKE '%%$keyword%%' OR id LIKE '%$keyword%'  ORDER BY id DESC ");
					$query->execute();
				  ...
				  <div class="col mb-4">
					<div class="card h-100">
					  <img src="../Image/Gallery/<?php echo $row['Image']; ?>" class="card-img-top" alt="" height="300px" width="250px">
					  <div class="card-body">
							<p class="card-text">
							  <font color="#b3b3b3">
						...
						<center>
								<a href="options/Edit-image.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit Image</a>  						
								<a href="options/delete-image.php?del=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure, you want to delete this Picture?');">Delete</a>
						</center>
					  </div>
					</div>
				  </div>
...
<div class="container">
    <div class="row row-cols-1 row-cols-md-3">
					...
					$query = $dbh->prepare("SELECT * FROM gallery ORDER BY id DESC ");
					$query->execute();
				  ...
				  <div class="col mb-4">
					<div class="card h-100">
					  ...
					  <div class="card-body">
						...
						<center>
								<a href="options/Edit-image.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit Image</a>  						
								<a href="options/delete-image.php?del=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure, you want to delete this product?');">Delete</a>
						</center>
					  </div>
					</div>
				  </div>
