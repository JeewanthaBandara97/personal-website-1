    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0" class="nav nav-pills">
      ...
      <li class="nav-item dropdown ">
        ...
        <div class="dropdown-menu active" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item active" href="Shop.php">Posted Product</a>
		  <div class="dropdown-divider"></div>
...
<div class="container">
    ...
    <div class="row row-cols-1 row-cols-md-3">
					...
					$query = $dbh->prepare("SELECT * FROM product WHERE ProductName LIKE '%%$keyword%%' OR ProductID LIKE '%$keyword%'  ORDER BY id DESC ");
					$query->execute();
				  ...
				  <div class="col mb-4">
					<div class="card h-100">
					  <img src="../Image/Products/<?php echo $row['Image1']; ?>" class="card-img-top" alt="" height="250px" width="300px">
					  <div class="card-body">
						...
						<center>
								<a href="options/Edit-product.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit Details</a> 
								<a href="options/Edit-product-Images.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit Images</a>								
								<a href="options/delete-product.php?del=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure, you want to delete this product?');">Delete</a>
						</center>
					  </div>
					</div>
				  </div>
...
<div class="container">
    <div class="row row-cols-1 row-cols-md-3">
					...
					$query = $dbh->prepare("SELECT * FROM product ORDER BY id DESC ");
					$query->execute();
